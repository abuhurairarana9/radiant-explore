    ...
    >
      ...
      >
        <motion.div variants={itemVariants} className="mb-16">
          <h2 className="section-heading text-gradient">About Me</h2>
          ...
          <motion.div variants={itemVariants}>
            ...
            <div className="space-y-6">
              <div className="glass rounded-xl p-5">
                <div className="text-sm font-medium text-muted-foreground mb-1">Present</div>
              ...
              <div className="glass rounded-xl p-5">
                <div className="text-sm font-medium text-muted-foreground mb-1">Previously</div>
              ...
              <div className="glass rounded-xl p-5">
                <div className="text-sm font-medium text-muted-foreground mb-1">Started as</div>
